...
export function MobileMenu({ open, onClose }: MobileMenuProps) {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className='absolute left-4 right-4 top-16 rounded-2xl border border-white/10 bg-black/90 p-2 backdrop-blur-xl md:hidden'
    >
      ...
      <div className='mt-4 flex gap-4 border-t border-white/10 px-4 pt-4'>
        {socialIcons.map((s) => {
          const Icon = s.icon;
          return (
            <a
